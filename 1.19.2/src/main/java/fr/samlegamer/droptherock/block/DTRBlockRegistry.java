...
public class DTRBlockRegistry
{
    ...
    public static final RegistryObject<Block> loose_rock = register("vanilla_deepslate_loose_rock", LooseRockBlock::new, "minecraft");
    ...
    public static void createLooseRock()
	{
		...
		{
			final String modid = vanilla.rock().split(":")[0];
	...
	public static void createModdedCobblestone()
	{
		...
		for(Rock mod : rocks)
		{
            final String modid = mod.rock().split(":")[0];
            ...
            final RegistryObject<Block> cobblestone_stairs = register(name+"_stairs", () -> new StairBlock(() -> cobblestone.get().defaultBlockState(), Block.Properties.copy(Blocks.COBBLESTONE_STAIRS)), modid);
