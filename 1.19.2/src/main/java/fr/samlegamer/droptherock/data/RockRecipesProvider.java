...
public class RockRecipesProvider extends RecipeProvider
{
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer)
    {
        ...
        for (Rock rock : rocks) {
            ...
            Block blockCobble = ForgeRegistries.BLOCKS.getValue(new ResourceLocation(rock.cobblestone()));
            Block blockCobbleSlab = ForgeRegistries.BLOCKS.getValue(new ResourceLocation(rock.cobblestone()+"_slab"));
            Block blockCobbleStairs = ForgeRegistries.BLOCKS.getValue(new ResourceLocation(rock.cobblestone()+"_stairs"));
            Block blockCobbleWall = ForgeRegistries.BLOCKS.getValue(new ResourceLocation(rock.cobblestone()+"_wall"));
...
//                            .build(consumer, new ResourceLocation(DropTheRock.MODID, modidRock+"_"+nameRock + "_furnace"));
                    ...
                    SingleItemRecipeBuilder.stonecutting(Ingredient.of(blockCobble), blockCobbleWall).unlockedBy("has_stone", has(blockCobble))
...
//            mattock(consumer, "iceandfire", DTRItemRegistry.IAF_DRAGONBONE_MATTOCK.get(), IafItemRegistry.DRAGON_BONE);
    ...
    private static void knife(Consumer<FinishedRecipe> consumer, String modLoaded, Item knife, Item mat)
    {
    ...
    private static void saw(Consumer<FinishedRecipe> consumer, String modLoaded, Item saw, Item mat)
    {
        ConditionalRecipe.builder().addCondition(new ModLoadedCondition(modLoaded))
    ...
    private static void mattock(Consumer<FinishedRecipe> consumer, String modLoaded, Item saw, Item mat)
    {
        ConditionalRecipe.builder().addCondition(new ModLoadedCondition(modLoaded))
                .addRecipe(ShapedRecipeBuilder.shaped(saw).group("saw")
                        .unlockedBy("has_material", has(mat))
