...
public class RockBlockstatesProvider extends BlockStateProvider
{
    ...
    protected void registerStatesAndModels() {
        ...
        stairsBlock((StairBlock) ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DropTheRock.MODID, exCobble + "_stairs")), new ResourceLocation(DropTheRock.MODID, "block/" + exCobble));
...
//        }
        ...
        for(Rock rock : cobblestones)
        {
            ...
            StairBlock cobblestone_stairs = (StairBlock) ForgeRegistries.BLOCKS.getValue(new ResourceLocation(DropTheRock.MODID, name + "_stairs"));
