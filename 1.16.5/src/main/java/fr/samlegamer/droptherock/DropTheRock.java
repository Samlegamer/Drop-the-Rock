...
public class DropTheRock
{
	...
	private void onGatherData(GatherDataEvent event) {
		...
		if (event.includeClient()) {
			generator.addProvider(new RockBlockstatesProvider(generator, existingFileHelper));
			generator.addProvider(new RockItemsModelsProvider(generator, existingFileHelper));
		}

		if(event.includeServer())
		{
			generator.addProvider(new RockRecipesProvider(generator));
            generator.addProvider(new RockBlocksTagsProvider(generator, existingFileHelper));
            generator.addProvider(new RockItemsTagsProvider(generator, existingFileHelper));
        }
	}
